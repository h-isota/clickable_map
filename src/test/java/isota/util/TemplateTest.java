...
""";
	...
	/**
	 * {@link isota.util.Template#setParam(java.lang.String, java.lang.String)} のためのテスト・メソッド。
	 */
	@Test
	public void testSetParam() {
		assertThrows(RuntimeException.class, () -> { tplObj.setParam("hoge", "value"); });
		...
		assertThrows(RuntimeException.class, () -> { tplObj.setParam("test1", "value"); });
	}
